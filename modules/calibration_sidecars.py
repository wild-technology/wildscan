...
(project decision 2026-08-08: when using COLMAP output, calibration groups
are set PER-CAMERA and the manufacturer resized-corrected calibration is
supplied as an Approximate prior).

DELIVERY (field finding 2026-08-08): same-name sidecar auto-import is
...
-setPriorLensGroup. See FINDINGS 2026-08-08.
