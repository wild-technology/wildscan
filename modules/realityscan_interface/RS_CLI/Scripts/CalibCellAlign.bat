...
::
:: Field finding 2026-08-08: same-name XMP sidecar auto-import is
:: UNRELIABLE; calibration priors travel via EXPLICIT commands
:: (FINDINGS "sidecar AUTO-IMPORT retired"). Hooks:
::
...
::                             FINDINGS "calibration-CLI probe").
...
echo   silently does not stick from the delegated CLI (FINDINGS
