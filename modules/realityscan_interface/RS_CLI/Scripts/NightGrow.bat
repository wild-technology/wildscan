@echo off
setlocal
:: ATTACH-ONLY night-growth primitive set (project decision 2026-08-11).
...
::              enable -> save   (specified: added images are 'All Features',
...
::              orphans; largest stays disabled as specified) -> pinned
::              sfm keys -> align -> save
