...
MOUNTS: dict[str, dict | None] = {
    ...
    # Starboard's mount has NEVER been measured. The project excludes Starboard
...
# composed with the vehicle's). Adopted 2026-08-31. A MOUNTS entry always
...
# over-tight orientation accuracy FRAGMENTS solves. The house convention is a
...
class GeoreferenceImages(RSModule):
    ...
    def get_parameters(self) -> dict[str, Parameter]:
        ...
        # trajectory variable of the processing chain, and with prompt_user
        ...
        # Step 6 of the processing chain - "calculation/use of uncertainty".
    ...
    def _get_camera_pitch_offset(self, filename: str) -> float | None:
        ...
        at 30 deg accuracy, adopted 2026-08-31), and never for the VOYIS
