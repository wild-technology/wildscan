...
def test_stage_features_aborts_when_every_component_is_unassigned(
    ...
    driver, workdir, lines = _wire_driver(
    ...
    assert not (workdir / "features_plan.json").exists()
