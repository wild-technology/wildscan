...
-> model (project decision 2026-08-09: "After hull merge, we need to
...
see path pick). Own log: M:\ON2026_run2\logs\union.log. Chain:
  ...
  P  path pick by MEASURED commit limit (GlobalMemoryStatusEx):
       direct - limit >= DIRECT_MIN_COMMIT: union the EXISTING merged
                ...
                projected ~328 GB commit; only possible after the operator
...
def main():
    ...
    log(f"union driver start: {CODE} (project decision 2026-08-09: "
