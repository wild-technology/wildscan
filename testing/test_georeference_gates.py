...
Step 5/6/7 of the processing chain. Every case below was reachable on a new
...
def test_unmeasured_mount_takes_the_house_convention():
    """House convention (2026-08-31): a camera family with NO measured mount
...
def test_a_mixed_rig_of_measured_and_unmeasured_cameras_still_runs(tmp_path):
    ...
    false - the rig carries Port, Cinema AND Starboard, and
