:: SUPERSEDED (project decision 2026-08-07). Retired with zero callers -
:: superseded by AlignZone.bat + GrowZone.bat. Carries an unfixed
:: status log SHOULD-FIX by design (retired instead of fixed): no
:: AlignmentParams application, no deselect before exports
:: (status log 2026-07-24 clean-sweep review backlog, SHOULD-FIX list).
