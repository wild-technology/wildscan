...
(the regression check the operator asked for), then runs merge_zones.py to
...
GUI-visible by project decision (RS_HEADLESS=0). Cache pinned to E: - the
...
def run_merge(logger: logging.Logger) -> dict:
    ...
    cmd = [
        ...
        "--scale_gate", "true",
        # Project decision 2026-07-28. The hull fuses 4,860 of 4,865 cameras on
