"""H2024 final chain (planned staging 2026-07-28): non-hull merge -> hull
...
Phase 2  assemble_only: the non-hull finals + the hull
         ...
         georeferenced project. Expected: 7 components total.
...
def phase2_assembly(nonhull_report: dict, logger: logging.Logger) -> dict | None:
    ...
    # Hull last - imported into the completed non-hull scene (planned staging).
...
def phase4_models(confirmation: dict, logger: logging.Logger) -> list[dict]:
    ...
    # Dated RC_projects copies stay DEFERRED (decision 2026-07-28): arming
