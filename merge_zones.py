...
def main() -> int:
    ...
    parser.add_argument('--loss_tolerance', default=None,
                        help='fraction of input cameras a fusion may drop and '
                             ...
                             'Default 0 = exact subset sums only. This is a '
                             'policy decision: it changes acceptance semantics on the '
    ...
    logger.info('Merge stage complete. Evaluation gate: %s', eval_path)
    return 0
