...
investigation (4-part sweep, 2026-08-08, evidence in FINDINGS), the
requested assumption checks, and the implementation plan.
...
SUCCESS while silently leaving them separate (FINDINGS:326-342 —
...
both halves:
  1. ONE canonical image pool; zones reference the SAME on-disk paths
     ...
     export, FINDINGS:1987-2002, hardlinks validated).
...
## 5b. Probe results (2026-08-08, same evening — FINDINGS has detail)
