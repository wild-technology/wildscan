...
| Empirical record | Pre-release development through 2026-07-29; revised against wildscan 1.0.0 (2026-08-31) |
| Platform | Windows 11, native (no WSL), multi-GPU CUDA, cmd/`.bat`/PowerShell substrate |
| Written | 2026-08-04; revised 2026-09-21 |
