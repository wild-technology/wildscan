...
**Citation note.** the NA167 notes numbers its bug findings twice over:
...
is not obvious from context. [VERIFIED-by-inspection: the NA167 notes
§2, read 2026-08-04]
...
[VERIFIED: NA167 notes §`-align`; corroborated by the D7 probe wave and by every
...
- The YPR convention itself **is** settled: Epic staff (OndrejTrhan, 2023-10-23, Epic
  ...
  the written logs] [SUPERSEDED, same day: a claim that "Port is 90° wrong" — refuted
...
**Project decision in force: orientation priors ON at alignment, conservative 15° YPR
...
[VERIFIED: FINDINGS, MERGE_TEST_PLAN, fresh-run record 2026-07-24, status log, 2026-07-21 …
2026-07-28]
...
Measurement caveat (caught in review): workflows run **multiple** `RealityScan.exe` processes
...
Governing intent: a zone containing two discrete physical features surveyed in one
...
merge failure. [VERIFIED-as-decision: FINDINGS 2026-07-24]
...
[OPEN: never reported to Epic — status log P1 item 8. The forensic log is the report artifact.]
...
[VERIFIED: NA167 notes §1]. Membership must come from the XMP census.
...
[VERIFIED: NA167 notes §1; cell U16 PASS].
...
cameras get pose entries.** [VERIFIED: NA167 notes §1; the pipeline's primary
oracle]
...
[VERIFIED: FINDINGS 2026-07-25, 2026-07-26; status log 2026-07-27]
