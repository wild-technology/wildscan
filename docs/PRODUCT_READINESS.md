...
2026-08-08 re-audit — 17 parallel review passes, every must-fix adversarially verified at
HEAD — and 2026-08-08 persona role-play: four "knows the data, not the
tool" users driving the real tool on fixture data). Quality bar: software
