...
it matches the placement we asked for. ``--verify`` does that; pass it
explicitly on every real publish (it implies ``--poll``). Without it the
script stops at "tiling COMPLETE", which is not evidence of placement.
